...
export default function ServicesHeader() {
  ...
  // Freeze body scroll when any menu/popup is open
  useEffect(() => {
    const isAnyMenuOpen = isMegaMenuOpen || isIndustriesMenuOpen || isServicesMenuOpen || isMoreMenuOpen || isSearchOpen || isMobileMenuOpen;
  ...
  }, [isMegaMenuOpen, isIndustriesMenuOpen, isServicesMenuOpen, isMoreMenuOpen, isSearchOpen, isMobileMenuOpen]);

  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-[5%] pt-2">
