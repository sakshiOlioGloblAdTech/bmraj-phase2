...
export default function PackagingSolutionsSection() {
      ...
      <div className="max pad">
        ...
        >
          <div>
            ...
            Engineered for Every Industrial Need
            </h2>
            <p className="text-[16px] text-[#687975]">
            Drums, Containers, Packaging Bottles, Crates, and More
            </p>
          </div>
          <Link
            href="/products"
            className="hidden md:inline-flex items-center justify-center border-2 border-[#139C57] text-[#139C57] hover:bg-[#139C57] hover:text-white px-6 py-3 rounded-xl font-semibold text-[15px] transition-all btn-hover-lift btn-fill"
          >
            View All
          </Link>
        </div>
        ...
        <div className="mt-8 text-center md:hidden">
          <Link
            href="/products"
            className="inline-flex items-center justify-center border-2 border-[#139C57] text-[#139C57] hover:bg-[#139C57] hover:text-white px-6 py-3 rounded-xl font-semibold text-[15px] transition-all btn-hover-lift"
          >
            View All
          </Link>
        </div>
